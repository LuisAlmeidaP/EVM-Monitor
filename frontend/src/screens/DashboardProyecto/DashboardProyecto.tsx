...
export function DashboardProyecto() {
  ...
  const { proyecto, analisis, actividades, cargando, error } = useDashboardProyecto(proyectoId ?? '');
  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-10 sm:px-6">
      ...
      {cargando && <EstadoDeCarga mensaje="Cargando dashboard del proyecto..." />}
      {error && (
        <div className="mt-4">
        ...
        <>
          ...
          {actividades.length === 0 && (
            <EmptyState
              ...
              accion={
                <Link to={urlActividades}>
                  <Button>Crear la primera actividad</Button>
                </Link>
              }
            />
          )}
            ...
            <>
              ...
              <section aria-label="Actividades del proyecto">
                <div className="mb-3 flex items-center justify-between">
                  ...
                  <Link to={urlActividades} className="text-sm font-medium text-acento hover:text-acento-intenso">
